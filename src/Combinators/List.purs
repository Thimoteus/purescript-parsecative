...
uncons :: ∀ eff e a. Semigroup e => ParserError e => Parsecative eff e (List a) a
uncons = C.uncons List.uncons

elementBy :: ∀ eff e a. Semigroup e => ParserError e => (a -> a -> Boolean) -> a -> Parsecative eff e (List a) Unit
elementBy eq a = void (uncons |= eq a)

element :: ∀ eff e a. Semigroup e => ParserError e => Eq a => a -> Parsecative eff e (List a) Unit
element = elementBy eq

untilBy :: ∀ eff e a. Semigroup e => ParserError e => (List a -> List a -> Boolean) -> (a -> Boolean) -> Parsecative eff e (List a) Unit
untilBy eq pred = void (manyBy eq (uncons |= not <<< pred))

until :: ∀ eff e a. Semigroup e => ParserError e => Eq a => (a -> Boolean) -> Parsecative eff e (List a) Unit
until = untilBy eq

empty :: ∀ eff e a. Semigroup e => ParserError e => Parsecative eff e (List a) Unit
empty =
  Parsecative \ref -> do
...
manyBy :: ∀ eff e s a. Semigroup e => (s -> s -> Boolean) -> Parsecative eff e s a -> Parsecative eff e s (List a)
...
someBy :: ∀ eff e s a. Semigroup e => (s -> s -> Boolean) -> Parsecative eff e s a -> Parsecative eff e s (NonEmptyList a)
someBy pred p = cons' <$> p <*> manyBy pred p
  where
  cons' x xs = NonEmptyList (x :| xs)

many :: ∀ eff e s a. Semigroup e => Eq s => Parsecative eff e s a -> Parsecative eff e s (List a)
many = manyBy eq

some :: ∀ eff e s a. Semigroup e => Eq s => Parsecative eff e s a -> Parsecative eff e s (NonEmptyList a)
some = someBy eq

int :: ∀ eff e. Semigroup e => ParserError e => Parsecative eff e (List String) Int
int =
  Parsecative \ref -> do
    str <- liftEff $ Ref.readRef ref
...
number :: ∀ eff e. Semigroup e => ParserError e => Parsecative eff e (List String) Number
number =
  Parsecative \ref -> do
    str <- liftEff $ Ref.readRef ref
    case List.uncons str of
...
pair :: ∀ eff e a. Semigroup e => ParserError e => Parsecative eff e (List a) (Tuple a a)
